...
class InjuryCentreTest {
	...
	void testFindAllCentre() {
		...
		Assert.assertEquals(centrelist.get(1).getPersonName(),"rajesh");
		Assert.assertEquals(centrelist.get(2).getPersonName(),"raghu");
		Assert.assertEquals(centrelist.get(3).getPersonName(),"king");
	}
